...
export default function NotFound() {
  ...
  return (
    <section className="max-w-xl mx-auto px-6 py-28 text-center flex flex-col items-center">
      ...
      <h1 className="font-serif text-3xl tracking-tight text-brand-ink font-light mb-3">{t.notFoundTitle}</h1>
      <p className="text-sm font-light text-brand-gray mb-8">{t.notFoundText}</p>
      <Link
        href="/"
