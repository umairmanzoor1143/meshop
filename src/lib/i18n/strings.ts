...
export interface Strings {
  ...
  // home
  heroKicker: string; heroTitle: string; heroSub: string; shopNow: string; heroLocal: string;
  promoTag: string; promoOn: string; promoShopWide: string; freeShipFrom: string; categories: string; viewAll: string; featured: string;
  // catalog
  ...
  description: string; buyNow: string; securePay: string; recommended: string;
  ...
  standard: string; premium: string; freeUnlocked: string; pickupInfo: string;
  ...
  // footer / misc
  footerAbout: string; footerTerms: string; contactInfo: string;
...
const de: Strings = {
  ...
  heroKicker: "Genossenschaft · seit 1997", heroTitle: "Der Marktplatz für lokalen Genuss.", heroSub: "Über 90 Produzenten aus Küssnacht am Rigi und Umgebung — direkt und fair, an einem Ort.", shopNow: "Jetzt einkaufen", heroLocal: "Lokal & Fair",
  promoTag: "AKTION", promoOn: "auf", promoShopWide: "auf das ganze Sortiment", freeShipFrom: "Gratis Lieferung ab {amount}", categories: "Kategorien", viewAll: "Alle ansehen", featured: "Ausgewählte Angebote",
  ...
  description: "Beschreibung", buyNow: "Jetzt kaufen", securePay: "Sichere Zahlung garantiert.", recommended: "Empfohlene Produkte",
  ...
  standard: "Standard", premium: "Premium (24 h)", freeUnlocked: "Gratis-Lieferung freigeschaltet",
  pickupInfo: "Abholung am Marktstand · Seestrasse 14, 6403 Küssnacht · Di–Fr 09–18 Uhr, Sa 08–14 Uhr. Du erhältst eine Nachricht, sobald deine Bestellung bereit ist.",
  ...
  step1: "Bestellung wird kommissioniert", step2: "Versand / Bereitstellung zur Abholung", step3: "Genuss vom Rigi",
  myAccount: "Mein Konto", orders: "Bestellungen", profile: "Profil", addresses: "Adressen", logout: "Abmelden", orderHist: "Bestellverlauf",
  footerAbout: "Eine Genossenschaft von über 90 lokalen Produzentinnen und Produzenten aus der Region Küssnacht am Rigi.", footerTerms: "AGB", contactInfo: "Kontaktangaben",
...
const en: Strings = {
  ...
  heroKicker: "Cooperative · since 1997", heroTitle: "The marketplace for local flavour.", heroSub: "Over 90 producers from Küssnacht am Rigi and the region — direct and fair, all in one place.", shopNow: "Shop now", heroLocal: "Local & Fair",
  promoTag: "OFFER", promoOn: "on", promoShopWide: "storewide", freeShipFrom: "Free delivery over {amount}", categories: "Categories", viewAll: "View all", featured: "Featured offers",
  ...
  description: "Description", buyNow: "Buy Now", securePay: "Secure your payment guarantee.", recommended: "Recommended Products",
  ...
  standard: "Standard", premium: "Premium (24 h)", freeUnlocked: "Free delivery unlocked",
  pickupInfo: "Pickup at the market stand · Seestrasse 14, 6403 Küssnacht · Tue–Fri 09:00–18:00, Sat 08:00–14:00. You'll get a message once your order is ready.",
  ...
  step1: "Order is being picked", step2: "Shipping / ready for pickup", step3: "Enjoy the taste of Rigi",
  myAccount: "My account", orders: "Orders", profile: "Profile", addresses: "Addresses", logout: "Log out", orderHist: "Order history",
  footerAbout: "A cooperative of over 90 local producers from the Küssnacht am Rigi region.", footerTerms: "Terms", contactInfo: "Contact",
...
const fr: Strings = {
  ...
  heroKicker: "Coopérative · depuis 1997", heroTitle: "Le marché des saveurs locales.", heroSub: "Plus de 90 producteurs de Küssnacht am Rigi et de la région — en direct et équitable.", shopNow: "Acheter", heroLocal: "Local & équitable",
  promoTag: "OFFRE", promoOn: "sur", promoShopWide: "sur tout l\u2019assortiment", freeShipFrom: "Livraison gratuite dès {amount}", categories: "Catégories", viewAll: "Voir tout", featured: "Offres sélectionnées",
  ...
  description: "Description", buyNow: "Acheter maintenant", securePay: "Paiement 100 % sécurisé.", recommended: "Produits recommandés",
  ...
  standard: "Standard", premium: "Premium (24 h)", freeUnlocked: "Livraison gratuite débloquée",
  pickupInfo: "Retrait au stand · Seestrasse 14, 6403 Küssnacht · mar–ven 09h–18h, sam 08h–14h. Vous recevrez un message dès que votre commande est prête.",
  ...
  step1: "Commande en préparation", step2: "Expédition / prête au retrait", step3: "Savourez le Rigi",
  myAccount: "Mon compte", orders: "Commandes", profile: "Profil", addresses: "Adresses", logout: "Déconnexion", orderHist: "Historique",
  footerAbout: "Une coopérative de plus de 90 producteurs locaux de la région de Küssnacht am Rigi.", footerTerms: "CGV", contactInfo: "Contact",
...
const it: Strings = {
  ...
  heroKicker: "Cooperativa · dal 1997", heroTitle: "Il mercato del gusto locale.", heroSub: "Oltre 90 produttori di Küssnacht am Rigi e dintorni — diretto ed equo.", shopNow: "Acquista", heroLocal: "Locale ed equo",
  promoTag: "OFFERTA", promoOn: "su", promoShopWide: "su tutto l\u2019assortimento", freeShipFrom: "Consegna gratuita da {amount}", categories: "Categorie", viewAll: "Vedi tutto", featured: "Offerte in evidenza",
  ...
  description: "Descrizione", buyNow: "Compra ora", securePay: "Pagamento sicuro garantito.", recommended: "Prodotti consigliati",
  ...
  standard: "Standard", premium: "Premium (24 h)", freeUnlocked: "Consegna gratuita sbloccata",
  pickupInfo: "Ritiro al banco del mercato · Seestrasse 14, 6403 Küssnacht · mar–ven 09–18, sab 08–14. Riceverai un messaggio quando l'ordine è pronto.",
  ...
  step1: "Ordine in preparazione", step2: "Spedizione / pronto per il ritiro", step3: "Gusta il Rigi",
  myAccount: "Il mio account", orders: "Ordini", profile: "Profilo", addresses: "Indirizzi", logout: "Esci", orderHist: "Storico ordini",
  footerAbout: "Una cooperativa di oltre 90 produttori locali della regione di Küssnacht am Rigi.", footerTerms: "Termini", contactInfo: "Contatti",
